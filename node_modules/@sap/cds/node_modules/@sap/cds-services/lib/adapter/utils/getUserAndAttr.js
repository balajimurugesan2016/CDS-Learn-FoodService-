...
const _extendUser = (userAndAuth, _, service) => {
  if (_.req && _.req.authInfo) {
    userAndAuth.attr = _.req.authInfo
  }
...
const getUserAndAttr = (_, service) => {
  const userAndAuth = _getUserAndAuth(_.req)
  _extendUser(userAndAuth, _, service)
  return userAndAuth
}
