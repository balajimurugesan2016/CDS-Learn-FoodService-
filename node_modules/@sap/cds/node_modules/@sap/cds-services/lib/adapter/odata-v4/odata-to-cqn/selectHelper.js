...
const isViewWithParamSegments = pathSegments => {
  return (
    ...
    pathSegments[1].getNavigationProperty() &&
    pathSegments[1].getNavigationProperty()._navigationProperty &&
    pathSegments[1].getNavigationProperty()._navigationProperty.partner === 'Parameters'
  )
}
