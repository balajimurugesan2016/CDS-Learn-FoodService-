...
class NpmDependenciesHelper {
    ...
    static async updateDependencies(dependencies, options, logger) {
        ...
        const promises = Object.keys(dependencies).map(async (module) => { // NOSONAR
            ...
            if (dependencies[module] === NpmDependenciesHelper.REPLACE_TOKEN) {
                ...
                try {
                    ...
                    // rethrow javascript system errors, like TypeError, RefefenceError, ...
                    if (err.name !== 'Error') {
                        throw err;
                    }

                    // specifc 404 (not found) error due to missing npm registry
